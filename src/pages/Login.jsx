      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-8 animate-slide-up">
        ...
        <form onSubmit={handleEmailLogin} className="w-full flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            <label className="text-text-primary font-bold text-sm" htmlFor="login-email">Email</label>
            <input
              id="login-email"
              type="email"
              value={email}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-text-primary font-bold text-sm" htmlFor="login-password">Contraseña</label>
          ...
          <div className="text-center">
            <Link to="/forgot-password" className="text-accent-cyan text-sm font-semibold hover:underline font-mono">
